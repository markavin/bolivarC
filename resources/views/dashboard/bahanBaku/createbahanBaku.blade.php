...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            @endif
            <form action="{{ route('bahanBaku.store') }}" method="POST" id="createStockForm"
                onsubmit="validateForm(event)">
                @csrf
                <div class="form-group">
                    <label for="namaBahanBaku">Stock Name</label>
                    <span class="material-icons-outlined">badge</span>
                    <input type="text" id="namaBahanBaku" name="namaBahanBaku" placeholder="Enter a new stock name"
                        required>
                </div>
                <div class="form-group">
                    <label for="jumlahBahanBaku">Stock Quantity</label>
                    <span class="material-icons-outlined">inventory</span>
                    <input type="number" id="jumlahBahanBaku" name="jumlahBahanBaku"
                        placeholder="Enter a new stock quantity" required min="1">
                </div>
    ...
    <script>
        ...
        function closeSuccessModal() {
            ...
            document.getElementById('createStockForm').submit(); // Submit form after success modal
        }
