...
<head>
    ...
    <title>Bolívar Coffee Dashboard - Purchase</title>
...
<body>
    ...
    <script>
        ...
        function closeProfileModal() {
            ...
            window.location.href = '{{ route('pembelian.show') }}'; // Ganti dengan route atau URL yang sesuai
        }
        ...
        function closeResetPasswordModal() {
            ...
            window.location.href = '{{ route('pembelian.show') }}';
        }
    </script>
</body>
