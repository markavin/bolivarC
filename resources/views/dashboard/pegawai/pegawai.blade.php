    ...
    <script>
        ...
        function openDeleteModal(id, name) {
            ...
            document.getElementById('deleteMessage').innerText =
                `Are you sure you want to delete the employee with the name ${name}?`;
        ...
        function closeProfileModal() {
            ...
            window.location.href = '{{ route('pegawai.show') }}'; // Ganti dengan route atau URL yang sesuai
        }
        ...
        function closeResetPasswordModal() {
            ...
            window.location.href = '{{ route('pegawai.show') }}';
        }
    </script>
