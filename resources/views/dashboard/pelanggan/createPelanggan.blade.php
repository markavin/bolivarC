    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="NamaPelanggan" name="NamaPelanggan" placeholder="Enter a new customer name"  required>
            </div>

            <div class="form-group">
                <label for="NoHP" class="form-label">Phone Number</label>
                <span class="material-icons-outlined">call</span>
                <input type="text" class="form-control" id="NoHP" name="NoHP" placeholder="Enter a new phone number" required>
            </div>
        </div>
            
            <div class="form-actions">
                <button type="button" class="cancel-btn" onclick="window.location='{{ route('pelanggan.show') }}'">Cancel</button>
